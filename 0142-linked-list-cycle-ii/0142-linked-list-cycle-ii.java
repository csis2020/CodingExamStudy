...
//head = [3,2,0,-4], pos=1
//f:3->0->2->-4  : a+k*c+b = 2(a+b) <=> k*c = a+b  <=> k*c - a = b , b on the cycle after moving a, start of cycle. 
//s:3->2->0->-4  : a+b
// distance between heand and start of cycle : a
// distance between start of cycle and meeting node : b
// distance between meeting node and start of cycle: c
// 
// 1) find the meeting node 
