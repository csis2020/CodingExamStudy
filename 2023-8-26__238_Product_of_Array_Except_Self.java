...
// right side multiplication: 24,12, 4, 1
//multiplication except Self: 24, 12, 8, 6
//Time Complexity: O(N)
...
class Solution{
    public int[] productExceptSelf(int[] nums){
        ...
        //result: 1, 1, 2, 6,   result: [1, -1, -1, 0, 0]
        for(int i = 0; i < nums.length; i++){ //left side multiplication 
            result[i] = prev;
            prev = prev * nums[i];
        }
        ...
        //nums = [1, 2, 3, 4]   , nums=  [-1, 1,  0, -3 ,3]
        //result:  1, 1, 2, 6   , result: [1, -1, -1, 0, 0]
        //prev:   24,12, 4, 1   , prev:    0 , 0, -9, 3, 1
        //Updated===
        //result: 24, 12, 8, 6  , result: [ 0 , 0 ,9, 0, 0]
        for(int i = nums.length -1 ; i >= 0 ; i--){ //right side multiplication
            result[i] *= prev;
            prev *= nums[i];
        }
