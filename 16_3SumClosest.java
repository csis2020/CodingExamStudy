...
class Solution{
    public int threeSumClosest(int[] nums, int target){
        ...
        //Sort to find 2 sum using min/max values
        Arrays.sort(nums);
        ...
        for(int i = 0; i < length-1; i++ ){
            ...
            while(min < max){
                ...
                //Compare its absolute difference to previous absolute difference to find closest  3 sum
...
//2022.09.22 에 다시 아래 솔루션을 보니 어떻게 test 를 Pass 했는지 싶게..
// 좀 이상하네. leetcode 솔루션 처럼 ClosestNum 을 while 문 안에서 check  하는게 맞는듯. 
/*
//2022.09.07
//- two point 
// Time Complexity: O(n^2) ( sorting 에 걸리는 시간은 O(n log n) , O(n^2)가 더 큼.)
