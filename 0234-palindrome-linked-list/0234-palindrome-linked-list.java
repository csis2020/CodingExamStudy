...
class Solution{
    public boolean isPalindrome(ListNode head){
        ...
        //find half position
        ListNode fast = head; // 2 steps at a time
        ListNode slow = head; // 1 step at a time.
        //Input: head = [1,2,2,1]   head=[1,2,3,2,1]
        //f: 1->2->null             f:1->3->1
        //s: 1->2->2                s:1->2->3
        ...
        //reversed list for second half of list
        ListNode secondHead = slow;
        ListNode prev = null;
        ListNode next = null;
        //Input: secondhead = [2,1]   secondhead=[3,2,1]
        //next:null->1->null              next:null->2->1->null
        //prev:null->2->1                 prev:null->3->2->1
        //secondhead:2->1->null           secondhead:3->2->1->null
        //null<-2<-1                      null<-3<-2<-1
        ...
        //Input: head = [1,2,2,1]   head=[1,2,3,2,1]
        //secondHead : 1->2->null   secondHead:1->2->3->null
        //firstHead: 1-2->2->null   firstHead: 1->2->3->null
        while(secondHead != null){
