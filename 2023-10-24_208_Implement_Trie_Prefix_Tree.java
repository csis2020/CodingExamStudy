...
class Trie {
    ...
    //Space Complexity: O(N), where N is the key length, In the worst case newly inserted key doesn't share a prefix with the the keys already inserted in the trie. We have to add N new nodes,
    public void insert(String word) {
        TrieNode node = root;
